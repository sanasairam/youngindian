			...
			<div class="header-main">
				...
				<div class="head-right">
					<div class="top-nav">
						...
						<ul>
							<li><a href="<?php echo base_url();?>index.php/youngindian" class="active ">Home</a></li>
							<li><a href="<?php echo base_url();?>index.php/youngindian" >About</a></li>
							<li><a href="<?php echo base_url();?>index.php/youngindian" >Services</a></li>
							<li><a href="<?php echo base_url();?>index.php/youngindian" >Donate</a></li>
							<li><a href="<?php echo base_url();?>index.php/youngindian" >Gallery</a></li>
							<li><a href="<?php echo base_url();?>index.php/youngindian" >Contact</a></li>
							<div class="clearfix"> </div>
						</ul>
